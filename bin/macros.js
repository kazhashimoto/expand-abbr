...
macroMap.set('blog-comment-item', [
  'article>h6{__DIGEST__}+p{__COMMENT__}+(%blog-footer%)',
  'article>h6{__DIGEST__}+p%2,4%{__COMMENT__}+(%blog-footer%)',
  'article>h6{__DIGEST__}+p{__COMMENT__}+(%photo@0%)+(%blog-footer%)'
]);
